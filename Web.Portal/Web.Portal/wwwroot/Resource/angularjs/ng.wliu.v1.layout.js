            ...
            '<div wliu card3 body>',
                ...
                '<div wliu card3 center>',
                    ...
                    '<div wliu mobile style="text-align:right;margin-top:6px;">',
                        '<a href="javascript:void(0)" ng-if="enrollState()" ng-click="clickEnroll(guid)" class="btn btn-info btn-sm">{{Words(\'button.enroll\')}}</a>',
                        '<a href="javascript:void(0)" ng-if="detailState()" ng-click="clickDetail(guid)" class="btn btn-info btn-sm" style="margin:0px 6px;">{{Words(\'button.detail\')}}</a>',
                    '</div>',
                '</div>',
                '<div wliu card3 right desktop>',
                    '<a href="javascript:void(0)" ng-if="enrollState()" ng-click="clickEnroll(guid)" class="btn btn-info btn-sm" style="display:block;margin-top:6px;">{{Words(\'button.enroll\')}}</a>',
                    '<a href="javascript:void(0)" ng-if="detailState()" ng-click="clickDetail(guid)" class="btn btn-info btn-sm" style="display:block;margin-top:12px;">{{Words(\'button.detail\')}}</a>',
                '</div>',
            '</div>',
            '</div>'
        ].join(''),
        ...
        template: [
            '<div wliu card3>',
                ...
                '<div wliu card3 center>',
                    ...
                    '<div wliu mobile style="text-align:right;margin-top:6px;">',
                        '<a href="javascript:void(0)" ng-if="enrollState()" ng-click="clickEnroll(guid)" class="btn btn-info btn-sm">{{Words(\'button.enroll\')}}</a>',
                        '<a btn-detail guid="{{guid}}" href="javascript:void(0)" ng-if="detailState()" ng-click="clickDetail(guid)" class="btn btn-info btn-sm" style="margin:0px 6px;">{{Words(\'button.detail\')}}</a>',
                    '</div>',
                '</div>',
                '<div wliu card3 right desktop>',
                    '<a href="javascript:void(0)" ng-if="enrollState()" ng-click="clickEnroll(guid)" class="btn btn-info btn-sm" style="display:block;margin:6px;">{{Words(\'button.enroll\')}}</a>',
                    '<a btn-detail guid="{{guid}}" href="javascript:void(0)" ng-if="detailState()"  ng-click="clickDetail(guid)" class="btn btn-info btn-sm" style="display:block;margin:6px;">{{Words(\'button.detail\')}}</a>',
                '</div>',
                '</div>',
...
WLIU_NG.directive("layout.class.detail", function ($sce) {
    return {
        ...
        template: [
            '<div>',
                '<ul id="classlist-d1-{{guid}}" wliu tab9 color="sea">',
                ...
                '<div style="text-align:center;">',
                    '<a btn-detail-close href="javascript:void(0)" class="btn btn-info btn-sm" style="display:block;margin-top:12px;">{{Words(\'button.close\')}}</a>',
                '</div>',
            '</div>'
        ].join(''),
        controller: function ($scope, $window) {
