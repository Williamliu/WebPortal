            ...
            '<div wliu card noshadow>',
                ...
                '<div wliu card body>',
                    ...
                    '<p',
                        ...
                        '<span style="color:black;font-size:24px;">{{db.tables[tb].GuidColumn(guid, discounttext).value}}({{db.tables[tb].GuidColumn(guid, discount).value}}%): </span>',
                        '<span style="font-size:24px;color:orangered;">-${{db.tables[tb].GuidColumn(guid, discountamount).value}} {{db.tables[tb].GuidColumn(guid, currency).value}}</span>',
                    '</p>',
