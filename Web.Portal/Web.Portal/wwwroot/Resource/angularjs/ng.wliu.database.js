...
var wliuRowCommon = [
    ...
    'ng-attr="{\'input-invalid\': db.tables[tb].GuidColumn(guid, col).error.HasError()}" '
].join('');
var wliuRowToolTip = [
    'tooltip-toggle="hover" ',
    'tooltip-body="{{db.tables[tb].GuidColumn(guid, col).error.Message().nl2br()}}" ',
            ...
            '<div>',
                '<div ng-if="db.tables[tb].navi.isActive" style="display:block; height:40px; line-height:40px;">',
                    ...
                    '<div style="float:left;">',
                        ...
                        '<a wliu btn24 reload ng-click="reloadPage()" title="{{Words(\'navi.reload\')}}" ng-hide="db.tables[tb].navi.isLoading"></a>',
                        '<i class="fa fa-spinner fa-lg fa-pulse fa-fw" aria-hidden="true" ng-show="db.tables[tb].navi.isLoading"></i>',
...
var formRowToolTip = [
    'tooltip-toggle="hover" ',
    'tooltip-body="{{db.tables[tb].GuidColumnErrorMsg(col)}}" ',
    'tooltip-target="wliuToolTip" ',
    'tooltip-placement="down" '
].join('');
            ...
            '<div style="display:block; padding:0px; margin:0px; position:absolute; top:1mm; left:1mm; border-radius:8px; overflow:hidden; width:52.5mm; height:82.5mm;">',
                ...
                '<div style="display:block;position:absolute;top:24mm;left:0px;right:0px;z-index:9;width:52.5mm;text-align:center;">',
                    '<table border="0" style="min-height:42mm;width:52.5mm;" width="100%">',
                        ...
                        '<tr>',
                            '<td valign="middle" align="center">',
                                //'<div ng-if="db.tables[tb].rows[db.tables[tb].navi.current].columns[cert].value" style="display:inline-block;position:relative;padding:2px 4px;">',
                        ...
                        '<tr>',
                            '<td valign="middle" align="center">',
                                //'<div ng-if="db.tables[tb].rows[db.tables[tb].navi.current].columns[alias].value" style="display:inline-block;position:relative;padding:2px 4px;">',
        ...
        template: [
            '<div id="wliuDiagScanView" wliu float>',
                ...
                '<div body style="text-align:center;">',
                    '<img id="wliuDiagScanViewImage" ng-if="db.tables[tb].rows[db.tables[tb].navi.current].columns[photo] && db.tables[tb].rows[db.tables[tb].navi.current].columns[photo].value.length>0" src="{{db.tables[tb].rows[db.tables[tb].navi.current].columns[photo].value}}" style="width:{{ww}};height:{{hh}};max-width:{{maxww}};max-height:{{maxhh}};object-fit:contain;" />',
                    '<div wliu nophoto ng-if="db.tables[tb].rows[db.tables[tb].navi.current].columns[photo] && (!db.tables[tb].rows[db.tables[tb].navi.current].columns[photo].value || db.tables[tb].rows[db.tables[tb].navi.current].columns[photo].value.length<=0)">',
                        //'{{Words("image.notfound")}}',
                    '</div>',
                    '<div ng-if="!db.tables[tb].rows[db.tables[tb].navi.current].columns[photo]" style="color:red;font-size:48px;text-align:center;">',
                        '{{Words("row.notfound")}}',
                    '</div>',
                '</div>',
                '<div style="display:block;text-align:center;">',
                    '<label ng-if="db.tables[tb].rows[db.tables[tb].navi.current].columns[displayname]" style="display:inline-block;font-size:48px;font-weight:600;line-height:1.2;white-space:wrap;">{{db.tables[tb].CurrentRow().columns[displayname].value}}</label><br>',
                    '<label ng-if="db.tables[tb].rows[db.tables[tb].navi.current].columns[aliasname]" style="display:inline-block;font-size:36px;font-weight:600;line-height:1.2;white-space:wrap;">{{db.tables[tb].CurrentRow().columns[aliasname].value}}</label>',
                '<div>',
            '</div>'
        ].join(''),
        controller: function ($scope, $window) {
...
var wliuTreeToolTip = [
    'tooltip-toggle="hover" ',
    'tooltip-body="{{(db.tables[tb].GuidColumn(guid, col).error.HasError()?db.tables[tb].GuidColumn(guid, col).error.Message().nl2br():db.tables[tb].metas[col].title)}}" ',
    'tooltip-target="wliuToolTip" ',
    'tooltip-placement="down" '
].join('');
    ...
    return {
        ...
        template: [
            '<span wliu ',
                'ng-attr="{\'input-invalid\': db.tables[tb].CurrentColumnHasError(col)}" ',
                'tooltip-toggle="hover" ',
                'tooltip-body="{{(db.tables[tb].CurrentColumnHasError(col)?db.tables[tb].GuidColumnErrorMsg(col):db.tables[tb].metas[col].title)}}" ',
                'tooltip-target="wliuToolTip" ',
                'tooltip-placement="down"',
            '>',
