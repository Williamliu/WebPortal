...
WLIU.Gallery.prototype = {
    ...
    CurrentIndex: function () {
        return $.indexInList(this.images, { guid: this.rowGuid });
    },
    ...
    Remove: function (guid) {
        ...
        if (this.GuidImage(guid)) {
            ...
            this.rowGuid = this.images.length > 0 ? this.images[0].guid : "";
        }
    },
    Empty: function (guid) {
        if (this.GalleryAjaxErrorHandle()) return;
...
WLIU.Image = function (image) {
    if (image) {
        ...
        this.active = image.active || false;
